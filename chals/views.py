...
from .models import Challenge, ChallengeFile, ChallengeSolve
...
@csrf_exempt # TODO: DONT DO THIS :)
def ResolveState (request):
    if request.method == 'POST':
        return _post_resolvestate(request)
    else:
        return HttpResponseNotFound()

def _post_resolvestate (request):
    ...
    return HttpResponse(json.dumps({"results": result_state, "removed": removed_state}))
